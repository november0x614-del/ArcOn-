  ...
  ({
    ...
    return (
      <div className="flex justify-between items-center py-2.5 first:pt-0 last:pb-0">
        ...
        >
          <span
            className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-transform ${value ? "right-1" : "left-1"}`}
          ></span>
        </button>
      </div>
    );
    ...
    <div className="p-4 space-y-6 animate-in fade-in duration-300">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="bg-slate-50 px-4 py-3 border-b border-slate-100 flex items-center justify-between">
          ...
          <span className="text-[10px] bg-indigo-50 text-indigo-600 px-2.5 py-0.5 rounded-full font-extrabold uppercase">
            Limits
          </span>
        </div>
        <div className="p-4 space-y-4">
          ...
          <div className="flex justify-between items-center py-2.5 px-3 bg-slate-50 rounded-xl border border-slate-100 mt-2">
            ...
            >
              <span
                className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-transform ${config.gasSubsidyEnabled ? "right-1" : "left-1"}`}
              ></span>
            </button>
          </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="bg-slate-50 px-4 py-3 border-b border-slate-100 flex items-center justify-between">
          ...
          <span className="text-[10px] bg-emerald-50 text-emerald-600 px-2.5 py-0.5 rounded-full font-extrabold uppercase">
            Layanan
          </span>
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="bg-slate-50 px-4 py-3 border-b border-slate-100 flex items-center justify-between">
          ...
          <span className="text-[10px] bg-amber-50 text-amber-600 px-2.5 py-0.5 rounded-full font-extrabold uppercase">
            Pembayaran
          </span>
        </div>
        <div className="p-4 divide-y divide-slate-100">
