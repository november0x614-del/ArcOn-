      ...
      <div className="flex-1 overflow-y-auto pb-32 pt-0 scrollbar-hide z-20 md:px-4 lg:px-6 relative">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 lg:gap-6">
          ...
          {activeRekeningTab === 0 && (
            ...
            <div 
               className="bg-gradient-to-r from-blue-700 to-blue-900 rounded-2xl p-5 text-white shadow-[0_8px_20px_rgba(37,99,235,0.25)] relative overflow-hidden mb-3 cursor-pointer transition-all active:scale-[0.98] group border border-blue-600 animate-in fade-in duration-300"
                ...
                <div className="flex-1 text-left">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <div className="px-1.5 py-0.5 bg-white/10 rounded border border-white/20">
                      <span className="text-[7px] font-bold text-white uppercase leading-none">Testnet</span>
                    </div>
                  </div>
                  ...
                  <div className="mt-2.5 flex items-center gap-1.5">
                     ...
                     <span className="text-[10.5px] text-blue-100 font-medium">Network Active</span>
                  </div>
                </div>
            ...
            {selectedShortcuts.map((item) => (
               <MenuIcon 
                 ...
                 onClick={() => {
                   ...
                   if (item.label === "Bayar/VA") onNavigate('bayarVA');
                 }}
               />
            ))}
          </div>
        ...
        <section className="bg-white rounded-[24px] p-5 shadow-sm mx-4 lg:mx-0 mb-4 lg:mb-0">
          ...
          <div className="flex flex-col gap-4">
            <StockRow code="USDC" name="USD Coin" price="$1.00" change="0.00" percent="0.00%" isDown={false} />
            <StockRow code="ARC" name="Arc Network Gas Token" price="$24.10" change="+1.20" percent="+5.2%" isDown={false} />
            <StockRow code="ETH" name="Ethereum" price="$3,100" change="-45.00" percent="-1.4%" isDown={true} />
            <StockRow code="SOL" name="Solana" price="$145.20" change="+12.00" percent="+9.0%" isDown={false} />
            <StockRow code="BTC" name="Bitcoin" price="$65,000" change="-200.0" percent="-0.3%" isDown={true} />
          </div>
        ...
        <section className="bg-white rounded-[24px] p-5 shadow-sm mx-4 lg:mx-0 mb-8 lg:mb-0">
          ...
          <div className="grid grid-cols-2 gap-3">
            <ProductCard title="Merchant SDK" desc="Integrasi USDC on-chain." icon={<Box size={20} className="text-blue-500" />} />
            <ProductCard title="Testnet Faucet" desc="Klaim ARC Gas Token." icon={<Coins size={20} className="text-blue-500" />} />
            <ProductCard title="Smart Contracts" desc="Deploy template kontrak cerdas." icon={<Globe size={20} className="text-blue-500" />} />
            <ProductCard title="Staking Pool" desc="Stake & amankan jaringan." icon={<ShieldCheck size={20} className="text-blue-500" />} />
          </div>
        </section>
        </div>
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-[-28px] pointer-events-auto">
          <div className="relative group cursor-pointer flex flex-col items-center justify-center">
            ...
            <div className="relative w-[56px] h-[56px] bg-[#3FA2F6] rounded-[22px] flex flex-col items-center justify-center text-white shadow-lg transform transition-all duration-300 group-hover:-translate-y-0.5 active:translate-y-0 border-2 border-white/20">
               ...
               <span className="text-[9px] font-bold mt-0.5 tracking-tight uppercase">Bayar</span>
            </div>
          </div>
        </div>
