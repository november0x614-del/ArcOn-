  ...
  const createWallet = async () => {
    ...
    try {
      ...
      if (!authData.session) {
        ...
        if (newSignInError) {
          throw new Error(
            "Pendaftaran berhasil. Silakan cek kotak masuk Anda untuk mengonfirmasi email sebelum login.",
          );
        }
      }
      ...
      {step === 1 && (
        <div className="flex-1 p-6 flex flex-col pt-8">
          ...
          <p className="text-[14.5px] text-slate-500 mb-8 mt-2">
            Prepare your ID Card and enter details to create your Web3 Wallet.
          </p>

          <div className="space-y-6">
            <div>
              <label className="text-[12.5px] font-bold text-slate-800 mb-1 block">
                Username
              </label>
              <input
                type="text"
                ...
                className="w-full border-b-[2px] border-slate-200 py-2 outline-none focus:border-[#005faa] text-[16px] font-bold text-slate-800 transition-colors"
          ...
          <div className="mt-auto pt-6 pb-6 space-y-3">
            ...
            <p className="text-[11px] text-slate-400 text-center mt-4">
              By continuing, you agree to Arc Commerce Terms and Security
              Guidelines.
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 p-6 flex flex-col items-center justify-center text-center animate-in fade-in duration-300">
          {!error ? (
            <>
              ...
              <h3 className="text-[20px] font-bold text-slate-800 mb-3">
