...
CREATE TABLE public.transactions (
    ...
    type TEXT CHECK (type IN ('deposit', 'withdraw', 'transfer', 'batchTransfer', 'payment', 'swap', 'receive', 'purchase', 'stake', 'unstake_payout', 'bridge', 'mint_nft', 'swap_contract_call', 'treasury_sweep', 'escrow_release_payout', 'checkout_batch')) NOT NULL,
    status TEXT CHECK (status IN ('pending', 'success', 'failed', 'pending_approval')) NOT NULL,
    tx_hash TEXT,
