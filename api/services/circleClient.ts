 ...
 * Caches instances to prevent redundant adapter creation.
 */
const kitCache = new Map<string, any>();

export const getArcAppKit = (walletId: string) => {
    if (kitCache.has(walletId)) {
        return kitCache.get(walletId);
    }
